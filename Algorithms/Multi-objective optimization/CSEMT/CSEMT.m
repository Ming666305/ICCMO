classdef CSEMT < ALGORITHM
    ...
    % Single-constraint-based multitasking constrained multi-objective optimization 

    %------------------------------- Reference --------------------------------
    % K. J. Qiao, J. Liang*, K. J. Yu, X. X. Ban, C. T. Yue, B. Y. Qu,
    % P. N. Suganthan, Constraints separation based evolutionary multitasking for
    % constrained multi-objective optimization problems, IEEE/CAA Journal of
